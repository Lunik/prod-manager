...
service_status = sa.Enum('UP', 'DEGRADED', 'DOWN', name='servicestatus')
incident_status = sa.Enum('ACTIVE', 'STABLE', 'RESOLVED', 'COMPLETED', name='incidentstatus')
incident_severity = sa.Enum('CRITICAL', 'HIGH', 'MODERATE', 'LOW', 'MINOR', name='incidentseverity')
maintenance_status = sa.Enum('CREATED', 'VALIDATED', 'SHEDULED', 'IN_PROGRESS', 'SUCCESS', 'FAILED', name='maintenancestatus')
...
def upgrade():
    ...
    sa.Column('scope_id', sa.Integer(), nullable=False),
    sa.Column('service_id', sa.Integer(), nullable=False),
    sa.Column('service_planned_status', service_status, nullable=False),
    sa.Column('creation_date', sa.DateTime(), nullable=False),
...
def downgrade():
    ...
    service_status.drop(op.get_bind())
    incident_status.drop(op.get_bind())
    incident_severity.drop(op.get_bind())
    maintenance_status.drop(op.get_bind())
    # ### end Alembic commands ###
